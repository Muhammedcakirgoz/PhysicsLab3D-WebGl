...
export function setupGUI(objects, camera) {
  ...
  // Sadece sahneye eklenen nesneler (rampalar hariç)
  ...
  // Nesne eklendikçe listeyi güncelle
  ctrl.updateList = () => {
    // Eski controller'ı kaldır
    gui.remove(objController);
    // Yeni isim listesini al
    const names = getMovableNames();
    // Yeni controller ekle
  ...
  // Başlangıçta bir nesne varsa onu seç
  ctrl.updateList();
